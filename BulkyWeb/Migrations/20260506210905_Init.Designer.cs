...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyWeb.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.Comment", b =>
                {
                    b.HasOne("BulkyWeb.Models.TaskItem", "TaskItem")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyWeb.Models.TaskItem", b =>
                {
                    b.HasOne("BulkyWeb.Models.User", "AssignedUser")
                        .WithMany()
                        .HasForeignKey("AssignedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulkyWeb.Models.Project", "Project")
                        .WithMany()
