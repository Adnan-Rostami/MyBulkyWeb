...
{
    /// <inheritdoc />
    public partial class UserProjectTaskidComment : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedUserIdId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskItems_Projects_ProjectIdId",
                        column: x => x.ProjectIdId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskItems_Users_AssignedUserIdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_AssignedUserIdId",
                table: "TaskItems",
                column: "AssignedUserIdId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_ProjectIdId",
                table: "TaskItems",
                column: "ProjectIdId");
        }
