...
namespace BulkyWeb.Migrations
{
    ...
    [Migration("20260321165504_UserProjectTaskidComment")]
    partial class UserProjectTaskidComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyWeb.Models.TaskItem", b =>
                {
                    b.HasOne("BulkyWeb.Models.User", "AssignedUserId")
                        .WithMany()
                        .HasForeignKey("AssignedUserIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulkyWeb.Models.Project", "ProjectId")
                        .WithMany()
